...
sub settingsInitPrefs()
    ...
    qualities.Push({title: "20 Mbps 1080p", index: 12, maxBitrate: 20000, maxHeight: 1088, height: 1080})
    qualities.Push({title: "12 Mbps 1080p", index: 11, maxBitrate: 12000, maxHeight: 1088, height: 1080})
    qualities.Push({title: "10 Mbps 1080p", index: 10, maxBitrate: 10000, maxHeight: 1088, height: 1080})
    qualities.Push({title: "8 Mbps 1080p", index: 9, maxBitrate: 8000, maxHeight: 1088, height: 1080})
    qualities.Push({title: "4 Mbps 720p", index: 8, maxBitrate: 4000, maxHeight: 720})
    qualities.Push({title: "3 Mbps 720p", index: 7, maxBitrate: 3000, maxHeight: 720})
    qualities.Push({title: "2 Mbps 720p", index: 6, maxBitrate: 2000, maxHeight: 720})
    qualities.Push({title: "1.5 Mbps 480p", index: 5, maxBitrate: 1500, maxHeight: 480})
